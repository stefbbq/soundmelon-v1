Soundmelon::Application.routes.draw do
  ...
  get 'artist/new/artist'                       => 'artist#new',                            :as => :new_artist
  post 'artist/create/artist'                   => 'artist#create',                         :as => :create_artist
...
#  get 'edit/artist/:artist_name/:id'            => 'artist#edit',                    :as => :edit_artist
  ...
  get ':artist_name/edit/:artist_album_name'        => 'artist_photo#edit',                       :as => :edit_album
  match ':artist_name/delete/:artist_album_name'    => 'artist_photo#destroy_album',              :as => :delete_album
  ...
  get ':album_name/:id/photo_album_buzz'  => 'buzz#artist_photo_album_buzz',              :as => :artist_album_buzz
  ...
  match ':album_name/:id/photobuzz/create'=> 'buzz#artist_album_buzz_post',               :as => :artist_album_buzz_post
  match 'photobuzz/:id/create'            => 'buzz#artist_photo_buzz_post',               :as => :artist_photo_buzz_post
